...
const AverageTemperatureLabel = document.getElementById("TempLabel");
...
function TemperatureLoop() {
    ...
    Waters.forEach((Water, Index) => {
        ...
        AverageTemperatureLabel.innerHTML = `Temperature: ${AverageTemp.toFixed(1)}⁰C`;
        PressureLabel.innerHTML = `Pressure: ${(AverageTemp * 11.251).toFixed(1)} kPa`;
        EnergyLabel.innerHTML = `Produced: ${(AverageTemp * 11.251 * 4).toFixed(1)} MW`;
